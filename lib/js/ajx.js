...
function connectsocket(channel, uid) {
  ...
  jdschannel.on('msg', (data) => {
    if (data.hasOwnProperty('file_data')) {
      ...
      let targetProgress = (fileData.status != undefined) ? ((fileData.hasOwnProperty('progress')) ? Math.floor(fileData.progress)+"%" : '---%') : '100%';
      // if (data.hasOwnProperty('status')) console.log(data);
                                  ...
                                  case 0:
                                    ...
                                    let subRow_1_2_2_0_1 = document.createElement('A');
                                      if (FILE_STATUS == 'Waiting') {
                                        ...
                                        subRow_1_2_2_0_1.setAttribute('class', 'icon-flow-merge animate-grow');
                                        subRow_1_2_2_0.append(subRow_1_2_2_0_1); // sub row 1 2 2 (1<->4) 1
                                    ...
                                    if (x == 1) {
                                      for (var i = 0; i < 4; i++) {
                                        let sR2_head_field_0 = document.createElement('th');
                                            ...
                                            if (i == 1) sR2_head_field_0.innerText = "Filename";
                                            if (i == 2) sR2_head_field_0.innerText = "Downloader";
