                                        ...
                                        if (x == 0) {
                                          for (var i = 0; i < 5; i++) {
                                            let sR2_head_field_0 = document.createElement('th');
                                                ...
                                                if (i == 2) sR2_head_field_0.innerText = "Range";
                                                if (i == 3) sR2_head_field_0.innerText = "Progress";
                                                if (i == 4) sR2_head_field_0.innerText = "User";
                                              ...
                                              let sR2_row = document.createElement('tr');
                                                  ...
                                                  for (var i = 0; i < 5; i++) {
                                                    let sR2_row_field_0 = document.createElement('td');
                                                        ...
                                                        if (i == 1) sR2_row_field_0.innerText = item.order_name;
                                                        if (i == 2) sR2_row_field_0.innerText = item.byte_start+" - "+item.byte_end;
