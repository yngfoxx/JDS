      ...
      if (res != 0) {
        if (isJson(res)) {
          ...
          if (jRes.hasOwnProperty('server_error')) {
            ...
            const jdsChannel = io('ws://ws-jds-eu.herokuapp.com/py_'+GROUP_CHANNEL, {
                auth: { token: 'qPyFMKAdjtfL3Gq5pk2xDgy0SKMpEmLz', uid: jRes.UID }
              }
            );
            ...
            jdsChannel.on('connect', () => {
              ...
              focusedSocketChannel = GROUP_CHANNEL;
            });

            jdsChannel.on('connect_error', () => {
