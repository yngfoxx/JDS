                                ...
                                let subRow_1_2_1_0 = document.createElement('DIV');
                                    ...
                                    switch (div) {
                                      ...
                                      case 3: // FILE DOWNLOAD PROGRESS [SERVER SIDE]
                                        subRow_1_2_1_0_1.innerText = FILE_PROGRESS+"%";
                                ...
                                switch (div1) {
                                              ...
                                              if (res != 0) {
                                                if (isJson(res)) {
                                                  ...
                                                  if (jRes.hasOwnProperty('server_error')) {
                                                    ...
                                                    for (var i = 0; i < nDownloadData.length; i++) if (nDownloadData[i].rid == rID) openDownloadConfig(rID, nDownloadData[i].chunk_size);
                                                  }
                                                }
                                              }
                                            },
                                  ...
                                  case 3:
                                    let subRow_1_2_2_0_4 = document.createElement('A');
                                        subRow_1_2_2_0_4.setAttribute('class', 'icon-trash');
                                        subRow_1_2_2_0.classList.add('_del');
